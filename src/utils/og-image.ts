...
// Load fonts once at module level for efficiency
...
// Helper to create React-like element structure for Satori
function h(
  type: string,
...
/**
 * Generate an Open Graph image as a PNG buffer
 */
