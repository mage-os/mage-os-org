...
tagline: Legal
ogImage: /og/page/privacy.png
editFile: src/pages/privacy.mdx
---
...
If you provide images for the website, we recommend avoiding images with embedded location data (EXIF GPS), as visitors may be able to extract this information.
...
### Membership Services (Open Collective)

We use Open Collective to manage our members and financial contributions. They may collect details including:

- Your name, email address, and company name (if provided)
- Profile picture (if provided)

This information is shared with us for purposes of managing membership, accounting, and voter rolls.

For details, see the [Open Collective Privacy Policy](https://opencollective.com/privacypolicy).

### Contact Form (Formspark)

We use Formspark to process submissions from our contact form. When you submit the form:

- Your name, email address, subject, and message content are sent to Formspark
- Formspark stores this data in the European Union
- We receive your submission via email and may store it for follow-up purposes

For details, see the [Formspark Privacy Policy](https://formspark.io/legal/privacy-policy/).

### Cookie Consent Management (CookieYes)

We use CookieYes to manage cookie consent on our website. This service:

- Displays the cookie consent banner when you first visit
- Stores your consent preferences in a cookie (`cookieyes-consent`)
- Blocks non-essential cookies until you provide consent

CookieYes does not collect personal data beyond your consent preferences. For details, see the [CookieYes Privacy Policy](https://www.cookieyes.com/privacy-policy/).
...
Our contact form uses Cloudflare Turnstile to protect against spam and automated submissions. This service:

- Verifies that form submissions come from real users, not bots
- Does not use CAPTCHAs or collect personal data
- May set cookies to maintain verification state
...
| ------------------------ | ------------------------------------------------- |
| Contact form submissions | Until inquiry is resolved or upon request         |
...
For registered members, we store personal information provided in user profiles. Users can view, edit, or delete their personal information at any time (except usernames). Website administrators can also access and edit this information.
