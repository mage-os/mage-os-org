...
<Aside type="tip" title="Quick Summary">
**Be respectful, be inclusive, be collaborative.** If you see something concerning, report it to [conduct@mage-os.org](mailto:conduct@mage-os.org). We take all reports seriously and will respond within 48 hours.
</Aside>
...
<Aside type="caution" title="Report a Concern">
**Email:** [conduct@mage-os.org](mailto:conduct@mage-os.org)

All reports are handled confidentially. You will receive a response within 48 hours.
</Aside>
...
<CardGrid>
<Card title="General Questions" icon="information">
For questions about this Code of Conduct:

[info@mage-os.org](mailto:info@mage-os.org)
</Card>
<Card title="Report a Violation" icon="warning">
For reporting Code of Conduct violations:

[conduct@mage-os.org](mailto:conduct@mage-os.org)
</Card>
</CardGrid>
