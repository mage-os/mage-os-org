...
We are continuing to develop our grant program. If you have an idea for a feature that would benefit the broader Mage-OS community, reach out to us on [Discord](https://discord.com/invite/nvZDVA2NdC) to discuss the possibility.
...
|------------------|-------------------|
| **Join the conversation** | [Discord](https://discord.com/invite/nvZDVA2NdC) at chat.mage-os.org |
...
Contributors meet to discuss progress, infrastructure, tooling, and new features. Join the [Discord](https://discord.com/invite/nvZDVA2NdC) and participate! **If you just want to listen, that is fine too.**
...
|----------------|----------|
| **[Discord](https://discord.com/invite/nvZDVA2NdC)** | Real-time help, community discussions, quick questions |
...
Looking for help with your project? Reach out on [Discord](https://discord.com/invite/nvZDVA2NdC) and we can connect you with qualified professionals in our community.
