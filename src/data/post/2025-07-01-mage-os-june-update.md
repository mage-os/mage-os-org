...
- Several modules have been moved into the official [Mage-OS namespace](https://github.com/mage-os), including [Vinai’s cache-cleaning module](https://github.com/mage-os/magento-cache-clean) and others that were previously hosted in MageOSLab..
