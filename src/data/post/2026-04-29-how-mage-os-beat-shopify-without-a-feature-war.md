...
Their reasoning wasn't irrational. The existing Magento installation was several years behind on upgrades. No [Hyvä](https://www.hyva.io/). None of the modern features that had shipped since. When a competing integrator demoed a Business Central connection they'd stood up in 50 minutes, the pitch looked even more compelling.

I walked into that pitch with something different from a features list.
...
My first move was to reframe the question entirely. Instead of "which platform has a better page builder today?", I asked: "What will your competitors look like in 12 months?"

My answer: AI is about to commoditize every feature on any comparison spreadsheet. ChatGPT, Claude, and their successors are available to every merchant and every competitor equally. Everyone has access to the same knowledge.
