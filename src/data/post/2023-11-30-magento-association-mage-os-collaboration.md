...
David Lambauer initiated the [developer documentation project](https://devdocs.mage-os.org), inspiring us to launch a collaborative effort for improved merchant documentation. We aim to facilitate the installation, configuration, and use of Magento 2 stores for merchants.
...
As Mage-OS integrates all changes into Magento Open Source, this presents a valuable opportunity for Mage-OS to contribute upstream, and vice versa in the future. We actively encourage contributors from the Mage-OS community to participate in the Community Council.
...
On December 11, both Mathias and I will be at the [Christmage Meetup](https://www.integer-net.com/blog_english/magento-meetup-aachen-mage-os-magento-association) organized by Integer-net in Aachen, Germany. If you are in the vicinity, please join us in person. If not, send us your questions and comments beforehand to discuss them at the event.To contact us, join the [Mage-OS Discord](http://chat.mage-os.org) server or send an email to [Mathias Schreiber](mailto:mathias.schreiber@magentoassociation.org).
