...
[Mage-OS developer documentation](https://devdocs.mage-os.org/) is coming together well!
...
We’ve lined all but one duck in the row. In the last months we’ve arranged our bank account, accounting company, settled legal matters, and set up a Stripe account so that we can now accept membership contributions on our [Open Collective page](https://opencollective.com/mage-os).
...
[The Mage-OS Swag store is here](https://mage-os.myspreadshop.com/)! 
...
This event is the first one organized by a local chapter: [Mage-OS Nederlands](https://nl.meet-magento.com/)! The [MM23NL website](https://nl.meet-magento.com/) is absolutely beautiful and gives justice to the rich cultural history of the Netherlands, which is also one of the strongest markets for Magento. You can still become a sponsor, get your ticket and perhaps submit a talk.
