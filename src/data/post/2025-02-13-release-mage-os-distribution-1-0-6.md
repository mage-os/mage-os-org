...
Please check the [release notes for Magento Open Source 2.4.7](https://experienceleague.adobe.com/en/docs/commerce-operations/release/notes/magento-open-source/2-4-7) and the [patch notes for 2.4.7-p4](https://experienceleague.adobe.com/en/docs/commerce-operations/release/notes/security-patches/2-4-7-patches).

You can get Mage-OS from our primary composer repository, [repo.mage-os.org](https://repo.mage-os.org).

### What's Changed

- [Mage-OS 1.0.6 is based on Magento 2.4.7-p4](https://github.com/mage-os/mageos-magento2/pull/121) by [@rhoerr](https://github.com/rhoerr)

- [Split Magento and Mage-OS versions in ProductMetadata for compatibility](https://github.com/mage-os/mageos-magento2/pull/115) by [@rhoerr](https://github.com/rhoerr)

- [Fixed a bug when setting number of address line lower breaks checkout](https://github.com/mage-os/mageos-magento2/pull/117) by [@ProxiBlue](https://github.com/ProxiBlue)

- [Added Sansec eComscan Security Scan Workflow](https://github.com/mage-os/mageos-magento2/pull/112) by [@fballiano](https://github.com/fballiano)

**Full Changelog**: [1.0.5...1.0.6](https://github.com/mage-os/mageos-magento2/compare/1.0.5...1.0.6)
